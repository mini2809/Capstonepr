...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var babel_polyfill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! babel-polyfill */ \"./node_modules/babel-polyfill/lib/index.js\");\n/* harmony import */ var babel_polyfill__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(babel_polyfill__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _client_js_api_handler_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../client/js/api_handler.js */ \"./src/client/js/api_handler.js\");\n\n\n\nname = 'rajnandgaon';\nObject(_client_js_api_handler_js__WEBPACK_IMPORTED_MODULE_1__[\"getdataGeoname\"])(name).then(function (res) {\n  console.log(res);\n  return res;\n}).then(function (resp) {\n  return Object(_client_js_api_handler_js__WEBPACK_IMPORTED_MODULE_1__[\"getdataWeatherbit\"])(resp);\n});\n\n//# sourceURL=webpack:///./src/client/index.js?");

/***/ }),

/***/ "./src/client/js/api_handler.js":
/*!**************************************!*\
  !*** ./src/client/js/api_handler.js ***!
  \**************************************/
/*! exports provided: getdataGeoname, getdataWeatherbit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getdataGeoname\", function() { return getdataGeoname; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getdataWeatherbit\", function() { return getdataWeatherbit; });\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nvar Url = 'http://api.geonames.org/searchJSON?';\nvar username = 'mini928'; // <--------lat and long fetched from geoname api----------->\n\nfunction getdataGeoname(_x) {\n  return _getdataGeoname.apply(this, arguments);\n}\n\nfunction _getdataGeoname() {\n  _getdataGeoname = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(namej) {\n    var obj, fetchData, data, Data, lat, _long;\n\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            obj = {};\n            _context.next = 3;\n            return fetch(Url + 'name=' + namej + '&username=mini928&countryCode=IN&maxRows=10&style=SHORT');\n\n          case 3:\n            fetchData = _context.sent;\n            _context.next = 6;\n            return fetchData.text();\n\n          case 6:\n            data = _context.sent;\n            Data = JSON.parse(data);\n            console.log(Data);\n            lat = Data.geonames[0].lat;\n            _long = Data.geonames[0].lng;\n            obj.lat = lat;\n            obj[\"long\"] = _long;\n            return _context.abrupt(\"return\", obj);\n\n          case 14:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee);\n  }));\n  return _getdataGeoname.apply(this, arguments);\n}\n\nvar key = 'c1d26e97df11444c8fac6881f237df9e';\nvar url = ' https://api.weatherbit.io/v2.0/forecast/daily?lat=';\nfunction getdataWeatherbit(_x2) {\n  return _getdataWeatherbit.apply(this, arguments);\n}\n\nfunction _getdataWeatherbit() {\n  _getdataWeatherbit = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(obj) {\n    var fetchData, data, Data, i;\n    return regeneratorRuntime.wrap(function _callee2$(_context2) {\n      while (1) {\n        switch (_context2.prev = _context2.next) {\n          case 0:\n            _context2.next = 2;\n            return fetch(url + obj.lat + '&lon=' + obj[\"long\"] + '&key=' + key);\n\n          case 2:\n            fetchData = _context2.sent;\n            _context2.next = 5;\n            return fetchData.text();\n\n          case 5:\n            data = _context2.sent;\n            Data = JSON.parse(data);\n\n            for (i = 0; i <= 15; i++) {\n              console.log(Data.data[i].weather);\n            }\n\n          case 8:\n          case \"end\":\n            return _context2.stop();\n        }\n      }\n    }, _callee2);\n  }));\n  return _getdataWeatherbit.apply(this, arguments);\n}\n\n//# sourceURL=webpack:///./src/client/js/api_handler.js?");
